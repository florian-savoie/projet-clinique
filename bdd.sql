...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : dim. 26 mars 2023 à 17:33
...
CREATE TABLE IF NOT EXISTS `employes` (
  ...
  `role` enum('directeur','medecins','agents','patients') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `rdv` (
  ...
  `statut` enum('en_attente','paye') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'en_attente',
  PRIMARY KEY (`id`),
  KEY `patient_id` (`patient_id`),
  KEY `medecin_id` (`medecin_id`),
  KEY `acte_id` (`acte_id`)
...
(41, 26, 4, 0, '2023-11-09 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, 'en_attente'),
(42, 26, 4, 0, '2023-11-09 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, 'en_attente'),
(43, 26, 4, 0, '2023-11-09 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, 'en_attente'),
(44, 26, 4, 0, '2023-11-09 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, 'en_attente'),
(45, 26, 4, 0, '2023-03-09 00:00:00', NULL, 'Carte vitale', 'a jeun', NULL, NULL, '50.00', 'en_attente'),
(46, 26, 4, 0, '2023-03-09 00:00:00', 'Consultation', 'Carte vitale', 'a jeun', NULL, NULL, '50.00', 'en_attente'),
(47, 26, 4, 0, '2023-04-12 00:00:00', 'Cardiologue', 'Carte vitale', 'a jeun', NULL, NULL, '50.00', 'en_attente'),
(48, 26, 4, 0, '2023-04-14 00:00:00', 'Cardiologue', 'Ordonnance', 'florian test', NULL, NULL, '100.00', 'en_attente'),
(49, 26, 4, 0, '2023-04-13 12:00:00', 'Cardiologue', 'resultat d\'examens du jour anuel', 'test', NULL, NULL, '200.00', 'en_attente'),
(50, 26, 4, 0, '2023-01-08 00:00:00', 'Cardiologue', NULL, NULL, NULL, NULL, NULL, 'en_attente'),
(51, 26, 4, 0, '2023-01-08 00:00:00', 'Cardiologue', 'Carte vitale', 'a jeun', NULL, NULL, '50.00', 'en_attente');
COMMIT;
